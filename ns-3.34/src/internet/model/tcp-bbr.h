...
public:
  ...
  double      m_pacingMargin                {0.01};              //!< Bbr intentionally reduce the pacing rate by 1% to drain any standing queues. See https://groups.google.com/g/bbr-dev/c/50AQUVQaGCg/m/SSZUt90WAwAJ
  ...
  bool        m_isAppLimited                {false};             //!< A boolean recording whether the app is application-limited now
