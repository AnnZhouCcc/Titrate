...
public:
  ...
  TcpSocketState::TcpCongState_t GetCongState (void) const;
  ...
  TcpSocket::TcpStates_t GetSockState (void);
...
protected:
  ...
  /*Modification*/
  virtual void SetWienRate(Ptr<TcpSocketState> tcb, DataRate rate, DataRate prevRate, Time baseRtt, bool useWindow);
  /*Modification*/
