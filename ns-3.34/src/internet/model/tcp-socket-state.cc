...
TcpSocketState::GetTypeId (void)
{
  ...
  .AddAttribute("initWienRate"," initial rate that will be used by Tcp wien", DataRateValue(DataRate("1Gbps")), MakeDataRateAccessor (&TcpSocketState::wienRate),MakeDataRateChecker())
  .AddAttribute("minWienRate"," minimum rate that will be used by Tcp wien for each flow", DataRateValue(DataRate("100Mbps")), MakeDataRateAccessor (&TcpSocketState::minWienRate),MakeDataRateChecker())
  .AddAttribute("maxWienRate"," maximum rate that will be used by Tcp wien for each flow", DataRateValue(DataRate("10Gbps")), MakeDataRateAccessor (&TcpSocketState::maxwienRate),MakeDataRateChecker())
  .AddAttribute("AIWien"," additive increase Tcp wien", DataRateValue(DataRate("50Mbps")), MakeDataRateAccessor (&TcpSocketState::wienAddInc),MakeDataRateChecker())
  .AddAttribute("HighAIWien"," high additive increase used by Timely", DataRateValue(DataRate("150Mbps")), MakeDataRateAccessor (&TcpSocketState::wienAddIncHigh),MakeDataRateChecker())
  ...
  .AddAttribute ("useThetaPower", "enable ThetaPowerTcp", BooleanValue (false), MakeBooleanAccessor (&TcpSocketState::useThetaPower), MakeBooleanChecker ())
  ...
  .AddAttribute ("baseRtt", "baseRtt in the topology", TimeValue (MicroSeconds (60)), MakeTimeAccessor (&TcpSocketState::wienInitRtt), MakeTimeChecker ())
