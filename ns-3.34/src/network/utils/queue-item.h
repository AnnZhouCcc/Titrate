...
public:
  ...
  uint8_t GetIsDroppedByCodel(void);
  void SetIsDroppedByCodel(uint8_t value);
  uint8_t GetIsDequeuedByCodel(void);
  void SetIsDequeuedByCodel(uint8_t value);
...
private:
  ...
  uint8_t is_dropped_by_codel;
  uint8_t is_dequeued_by_codel;
};
