...
QueueDisc::Stats&
QueueDisc::Stats::operator += (const Stats& stats)
{
  nTotalReceivedPackets += stats.nTotalReceivedPackets;
  nTotalReceivedBytes += stats.nTotalReceivedBytes;
  nTotalSentPackets += stats.nTotalSentPackets;
  nTotalSentBytes += stats.nTotalSentBytes;
  nTotalEnqueuedPackets += stats.nTotalEnqueuedPackets;
  nTotalEnqueuedBytes += stats.nTotalEnqueuedBytes;
  nTotalDequeuedPackets += stats.nTotalDequeuedPackets;
  nTotalDequeuedBytes += stats.nTotalDequeuedBytes;
  nTotalDroppedPackets += stats.nTotalDroppedPackets;
  nTotalDroppedPacketsBeforeEnqueue += stats.nTotalDroppedPacketsBeforeEnqueue;
  nTotalDroppedPacketsAfterDequeue += stats.nTotalDroppedPacketsAfterDequeue;
  nTotalDroppedBytes += stats.nTotalDroppedBytes;
  nTotalDroppedBytesBeforeEnqueue += stats.nTotalDroppedBytesBeforeEnqueue;
  nTotalDroppedBytesAfterDequeue += stats.nTotalDroppedBytesAfterDequeue;
  nTotalRequeuedPackets += stats.nTotalRequeuedPackets;
  nTotalRequeuedBytes += stats.nTotalRequeuedBytes;
  nTotalMarkedPackets += stats.nTotalMarkedPackets;
  nTotalMarkedBytes += stats.nTotalMarkedBytes;
  return *this;
}
