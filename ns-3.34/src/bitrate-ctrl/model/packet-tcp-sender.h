#ifndef PACKET_TCP_SENDER_H
#define PACKET_TCP_SENDER_H
...
class PacketTcpSender  : public PacketSender{
public:
    static TypeId GetTypeId (void);
    PacketTcpSender (void);
    ~PacketTcpSender ();

    void SetParams (GameServer * server, void (GameServer::*)(uint32_t), uint16_t interval, 
...
private:
    ...
    double kDampingCoef;
    double kProtectDecreaseCoef;
};  // class PacketTcpSender
